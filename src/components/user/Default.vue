    ...
    >
      <v-list>
        <v-list-tile
          ...
          :key="i"
          @click.prevent = "$router.push('/user/' + item.push)"
        >
          <v-list-tile-action>
    ...
    data () {
      return {
        ...
        items: [
          ...
          { icon: 'event_note', push: 'cuti/all', title: 'Cuti' },
          { icon: 'event_note', push: 'aktif/all', title: 'Aktif' },
    ...
    methods: {
      ...
      openNotifs (item, index) {
        ...
        if (item.type === 'update cuti') {
          ...
          this.$router.push('/user/cuti/' + item.detail.cuti + '/' + item.cutiId)
        }
      },
      logout () {
